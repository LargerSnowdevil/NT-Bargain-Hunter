...
public class PostUserComment extends ViewAnimator implements View.OnClickListener {
    ...
    public PostUserComment(Context context) {
        super(context);
        init();
    }

    public PostUserComment(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.fragment_post_user_comment_button, this, true);
    }
