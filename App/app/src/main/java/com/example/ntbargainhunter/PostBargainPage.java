...
//
//        newPostImage = findViewById(R.id.imageButton);
//        newPostDesc = findViewById(R.id.descriptionText);
//        newPostTitle = findViewById(R.id.titleText);
//        newPostBtn = findViewById(R.id.submitbtn);
//        newPostProgress = findViewById(R.id.new_post_progress);
//
//        newPostImage.setOnClickListener(new View.OnClickListener() {
//            @Override
...
//                    // PHOTO UPLOAD
//
//                    UploadTask filePath = storageReference.child("bargain_images").child(randomName + ".jpg").putBytes(imageData);
//                    filePath.addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
//                        @Override
//                        public void onComplete(@NonNull final Task<UploadTask.TaskSnapshot> task) {
//
...
//                                byte[] thumbData = baos.toByteArray();
//
//                                UploadTask uploadTask = storageReference.child("bargain_images/thumbs")
//                                        .child(randomName + ".jpg").putBytes(thumbData);
//
//                                uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
//                                    @Override
...
//                                                if(task.isSuccessful()){
//
//                                                    Toast.makeText(PostBargainPage.this, "Bargain was added", Toast.LENGTH_LONG).show();
//                                                    Intent mainIntent = new Intent(PostBargainPage.this, MainActivity.class);
//                                                    startActivity(mainIntent);
//                                                    finish();
//
